...
![plot of chunk unnamed-chunk-3](../assets/2017-09-07-class04/unnamed-chunk-3-1.png)

The line does a decent job, but seems to overpredict house values in areas
...
This line, in constrast, seems to fit the data much more accurately.
...
![plot of chunk unnamed-chunk-10](../assets/2017-09-07-class04/unnamed-chunk-10-1.png)
...
![plot of chunk unnamed-chunk-11](../assets/2017-09-07-class04/unnamed-chunk-11-1.png)
...
The numbers in the coefficents give the degree of the first term,
a dot, and the degree of the second term. Once again, this more
complex model offers some (modest) gains over the simplier models.
...
stability). However, the higher order fits begin to overfit to the training
data. For degree six polynomials this creates a slightly worse fit. For
degree 10 the fit is signficantly worse. At degree 12, the validation RMSE
...
![](https://statsmaths.github.io/stat395/assets/img/pg38.pdf)

I have several videos that demonstrate the process of moving from overfitting
to underfitting. Here are three examples:
...
overfitting and underfitting still apply.
...
A simple plots show how using longitude and latitude creates and adhoc
map.
...
![plot of chunk unnamed-chunk-19](../assets/2017-09-07-class04/unnamed-chunk-19-1.png)

If you know California well, you may be able to infer a lot from this
plot. Otherwise, layering a map under the data helps substantailly.
...
![plot of chunk unnamed-chunk-22](../assets/2017-09-07-class04/unnamed-chunk-22-1.png)
...
![plot of chunk unnamed-chunk-24](../assets/2017-09-07-class04/unnamed-chunk-24-1.png)
...
![plot of chunk unnamed-chunk-25](../assets/2017-09-07-class04/unnamed-chunk-25-1.png)
...
![plot of chunk unnamed-chunk-27](../assets/2017-09-07-class04/unnamed-chunk-27-1.png)
...
![plot of chunk unnamed-chunk-28](../assets/2017-09-07-class04/unnamed-chunk-28-1.png)
...
![plot of chunk unnamed-chunk-29](../assets/2017-09-07-class04/unnamed-chunk-29-1.png)
...
![plot of chunk unnamed-chunk-30](../assets/2017-09-07-class04/unnamed-chunk-30-1.png)
