...
{% highlight r %}
qplot(sleep_rem, awake, data = msleep, color = vore)
{% endhighlight %}



{% highlight text %}
## Error in eval(expr, envir, enclos): object 'sleep_rem' not found
{% endhighlight %}

![plot of chunk unnamed-chunk-11](../assets/2017-08-31-class02/unnamed-chunk-11-1.png)
...
{% highlight r %}
qplot(sleep_rem, awake, data = msleep, color = brainwt)
{% endhighlight %}



{% highlight text %}
## Error in eval(expr, envir, enclos): object 'brainwt' not found
{% endhighlight %}

![plot of chunk unnamed-chunk-12](../assets/2017-08-31-class02/unnamed-chunk-12-1.png)
...
{% highlight r %}
qplot(sleep_rem, awake, data = msleep, color = log(brainwt)) +
  scale_color_viridis()
{% endhighlight %}
...
![plot of chunk unnamed-chunk-14](../assets/2017-08-31-class02/unnamed-chunk-14-1.png)
...
adding the results of other functions, much like when we
added an alternative color scale. Here we use `geom_smooth`
...
![plot of chunk unnamed-chunk-15](../assets/2017-08-31-class02/unnamed-chunk-15-1.png)
