...
{% highlight text %}
## Error in validObject(.Object): invalid class "dgCMatrix" object: Not a valid 'Mnumeric' class object
{% endhighlight %}
...
{% highlight text %}
##  (Intercept)          jan          feb          mar          apr 
## -0.076405656  0.062430730 -0.105035694 -0.096584829  0.670794057 
##          jun          jul          aug          sep          oct 
##  0.567104111 -0.045414845 -0.008927545 -0.091286540  0.156858485 
##          nov          dec 
## -0.204448223  0.104115347
{% endhighlight %}
...
{% highlight text %}
## Error: Column `month` must be a 1d atomic vector or a list
{% endhighlight %}
...
<img src="../assets/2017-09-26-class09/unnamed-chunk-21-1.png" title="plot of chunk unnamed-chunk-21" alt="plot of chunk unnamed-chunk-21" width="100%" /><img src="../assets/2017-09-26-class09/unnamed-chunk-21-2.png" title="plot of chunk unnamed-chunk-21" alt="plot of chunk unnamed-chunk-21" width="100%" /><img src="../assets/2017-09-26-class09/unnamed-chunk-21-3.png" title="plot of chunk unnamed-chunk-21" alt="plot of chunk unnamed-chunk-21" width="100%" /><img src="../assets/2017-09-26-class09/unnamed-chunk-21-4.png" title="plot of chunk unnamed-chunk-21" alt="plot of chunk unnamed-chunk-21" width="100%" />
