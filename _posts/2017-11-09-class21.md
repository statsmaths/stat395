...
The minimial tuning and tweaking, the results are fairly
...
{% highlight r %}
rasterImage(x224[id,,,],0,0,1,1)
{% endhighlight %}



{% highlight text %}
## Error in as.raster.array(image): a raster array must have exactly 3 dimensions
{% endhighlight %}
...
{% highlight r %}
dogs_cats <- read_csv("~/gh/ml_data/dogs_cats_2.csv")
X <- as.matrix(read_csv("~/gh/ml_data/dogs_cats_2_vgg16_cnn.csv"))
...
<img src="../assets/2017-11-09-class21/unnamed-chunk-18-1.png" title="plot of chunk unnamed-chunk-18" alt="plot of chunk unnamed-chunk-18" width="100%" /><img src="../assets/2017-11-09-class21/unnamed-chunk-18-2.png" title="plot of chunk unnamed-chunk-18" alt="plot of chunk unnamed-chunk-18" width="100%" /><img src="../assets/2017-11-09-class21/unnamed-chunk-18-3.png" title="plot of chunk unnamed-chunk-18" alt="plot of chunk unnamed-chunk-18" width="100%" /><img src="../assets/2017-11-09-class21/unnamed-chunk-18-4.png" title="plot of chunk unnamed-chunk-18" alt="plot of chunk unnamed-chunk-18" width="100%" />
